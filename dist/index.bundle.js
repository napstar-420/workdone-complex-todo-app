...
class UI {
    ...
    static renderTasks(project) {
        ...
        project.tasks.map(currentTask => {
            ...
            deleteTaskBtn.addEventListener('click', () => _task__WEBPACK_IMPORTED_MODULE_1__["default"].deleteTask(currentTask.projectId, currentTask.taskId))
            ...
            completeTaskBtn.addEventListener('click', () => _task__WEBPACK_IMPORTED_MODULE_1__["default"].completeTask(currentTask.projectId, currentTask.taskId))
    ...
    static getFormattedTime(time) {
        ...
        const formattedTime = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_3__["default"])(date, 'p');
        const formattedDate = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_3__["default"])(date, 'PP');
    ...
    static openEditTaskModel(projectId, taskId) {
        ...
        document.getElementById('edit-task-btn').addEventListener('click', () => _task__WEBPACK_IMPORTED_MODULE_1__["default"].editTask(projectId, taskId));
    ...
    static openProject(projectId) {
        ...
        Project.projectList.map(project => {
            ...
            if(project.id === projectId) {
                _UI__WEBPACK_IMPORTED_MODULE_2__["default"].renderTasks(project);
...
class Task {
  ...
  static editTask(projectId, taskId) {
    ...
    // Updates the DOM
    _UI__WEBPACK_IMPORTED_MODULE_2__["default"].renderTasks(_project__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[projectIndex]);
