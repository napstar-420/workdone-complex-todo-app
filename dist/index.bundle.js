...
class UI {
    ...
    static createTaskUiElement(currentTask) {
        ...
        deleteTaskBtn.addEventListener('click', () => _task__WEBPACK_IMPORTED_MODULE_1__["default"].deleteTask(projectId, taskId))
        ...
        completeTaskBtn.addEventListener('click', () => _task__WEBPACK_IMPORTED_MODULE_1__["default"].completeTask(projectId, taskId))
