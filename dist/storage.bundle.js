...
class UI {
    ...
    static renderTasks(project) {
        ...
        project.tasks.map(currentTask => {
            ...
            editTaskBtn.addEventListener('click', () => _task__WEBPACK_IMPORTED_MODULE_1__["default"].editTask())
...
class Project {
    ...
    static deleteProject(id) {
        ...
        _task__WEBPACK_IMPORTED_MODULE_1__["default"].taskList = [..._task__WEBPACK_IMPORTED_MODULE_1__["default"].taskList.filter(task => parseInt(task.projectId) !== id)];
        console.log(_task__WEBPACK_IMPORTED_MODULE_1__["default"].taskList)
        _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].updateStorage();
