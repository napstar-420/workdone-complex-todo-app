...
document
  .getElementById("list_today_tasks")
  .addEventListener("click", () => UI.renderTasks("TODAY_TASKS"));
document
  .getElementById("list_week_tasks")
  .addEventListener("click", () => UI.renderTasks("WEEK_TASKS"));
document
  .getElementById("list_all_tasks")
  .addEventListener("click", () => UI.renderTasks("ALL_TASKS"));
